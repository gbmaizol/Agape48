...
The aesthetic half of the old objection still stands and is now a usage rule rather than a build rule: **Controls stays off the calculator face.** The face, the LCD, the annunciators and the keypad remain raw Qt Quick, because a Controls button dropped on the face of an HP 48 looks like a Controls button dropped on the face of an HP 48. Controls is for the surfaces that are not pretending to be a calculator - `SettingsSheet.qml`, dialogs, the about screen. Pin the style to Basic so no Material or Universal assets come along for the ride.

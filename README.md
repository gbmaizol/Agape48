...
**English** · [Dansk](README.da.md) · [Deutsch](README.de.md) · [Español](README.es.md) · [Esperanto](README.eo.md) · [Français](README.fr.md) · [Português](README.pt-BR.md)
...
1. Download **[`Agape48-0.9.3-windows-x64-setup.exe`](https://github.com/gbmaizol/Agape48/releases/latest)** (17.4 MB).
...
The download is 36.0 MB and unpacks to 98 MB, nearly all of it Qt. It is built for **x86_64** against **glibc 2.39**, so Ubuntu 24.04, Mint 22, Debian 13 or anything newer. On an older distribution it stops at startup with a `GLIBC_2.xx not found` line, which reads like a crash and is not one. Tested on X11.

### Android

1. Download **[`Agape48-0.9.3-arm64-v8a.apk`](https://github.com/gbmaizol/Agape48/releases/latest)** (47.6 MB) onto the phone and tap it.
